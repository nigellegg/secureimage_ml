...
if __name__ == '__main__':
    ...
    total_data = np.append(np.append(data_fg, data_dp, data_k, axis=0), data_age, axis=0)
    ...
    img_list, exist_list, non_exist_list, gender_labels, age_labels, race_labels = verify_images(total_data, paths)
