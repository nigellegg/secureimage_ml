    ...
    for img in data:
        ...
        if os.path.isfile(img_path):
            ...
            if img is not None:
                ...
                if len(gender)>0:
                    if gender[0]=='m': gender_value=0
                    elif gender[0]=='f': gender_value=1
                    elif gender[0]=='u': gender_value=2
                    else: gender_value=5
                else:
                    gender_value=5
                ...
                if len(age)>0:
                    if age[0]=='t': age_value=0
                    elif age[0]=='m': age_value=1
                    elif age[0]=='e': age_value=2
                    elif age[0]=='u': age_value=3
                    else: age_value=5
                else:
                    age_value=5
                ...
                if len(race)>0:
                    if race[0]=='b': race_value=0
                    elif race[0]=='w': race_value=1
                    elif race[0]=='o': race_value=2
                    elif race[0]=='u': race_value=3
                    else: race_value=5
                else:
                    race_value=5
